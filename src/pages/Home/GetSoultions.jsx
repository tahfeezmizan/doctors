        ...
        <div className='container py-20 px-0 font-Inter'>
            <div className="grid grid-cols-6 gap-7">
                <div className="col-span-3">
                    ...
                    <p className="text-base font-normal pr-20 mb-11">We are proud to be a trusted healthcare provider in our community, and we look forward to serving you and your family with excellence, integrity, and compassion. Your health is our priority, and we are here for you every step of the way. We believe in treating each patient with dignity, respect, and empathy, ensuring that they receive the attention and care they deserve.
                    </p>
